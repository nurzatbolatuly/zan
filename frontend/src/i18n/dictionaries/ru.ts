...
export const ru: Dictionary = {
  ...
  status: {
    ...
    documentErrorPrefix: (reason) => `Не удалось подготовить документ: ${reason}`,
    attachDocumentButton: 'Составить документ по этому ответу',
    attachDocumentTypeLabel: 'Какой документ нужен?',
    attachDocumentSubmit: 'Составить',
    attachDocumentCancel: 'Отмена',
    attachDocumentGenerating: 'Готовим документ…',
  ...
  pipeline: {
    answer: 'Ищу нормы и готовлю ответ',
